...
if mode == "Creative Lab (School Mode)":
    render_school_chat()
    st.stop() 
CODING_LANGUAGES=["Python","JavaScript","HTML","CSS","PHP","Java","C","C++","C#"]; CODING_EXPLAIN_LANGUAGES={"Hindi":"Hindi","English":"English","Marathi":"Marathi","Bengali":"Bengali","Tamil":"Tamil","Telugu":"Telugu","Gujarati":"Gujarati","Kannada":"Kannada","Malayalam":"Malayalam","Odia":"Odia","Chinese":"Chinese","Japanese":"Japanese"}; CODING_STARTER={"Python":'print("Hello, ClyxessChat AI!")',"JavaScript":'console.log("Hello, ClyxessChat AI!");',"HTML":'<!DOCTYPE html><html><body><h1>Hello, ClyxessChat AI!</h1></body></html>',"CSS":"body { font-family: Arial; }","PHP":'<?php echo "Hello, ClyxessChat AI!"; ?>',"Java":'public class Main { public static void main(String[] args) { System.out.println("Hello, ClyxessChat AI!"); } }',"C":'#include <stdio.h>\nint main(){ printf("Hello, ClyxessChat AI!"); return 0; }',"C++":'#include <iostream>\nusing namespace std;\nint main(){ cout << "Hello, ClyxessChat AI!"; return 0; }',"C#":'using System;\nclass Program { static void Main(){ Console.WriteLine("Hello, ClyxessChat AI!"); } }'}; CODING_SYNTAX={"Python":"python","JavaScript":"javascript","HTML":"html","CSS":"css","PHP":"php","Java":"java","C":"c","C++":"cpp","C#":"csharp"}; def analyze_code_with_ai(client,code,programming_language,explanation_language): prompt=f"""You are ClyxessChat AI Coding Lab. Analyze this {programming_language} code. Explain in {explanation_language}. Return ONLY valid JSON with keys status,title,explanation,error,corrected_code,suggestion. status must be correct or error. Keep corrected_code in the SAME programming language. Explain what is wrong, why it happens, and how to fix it. If correct, keep the original code as corrected_code. Do not invent dependencies or external files. Code:\n{code}"""; response=None; last_error=None; models=GROQ_MODELS if "GROQ_MODELS" in globals() else ["openai/gpt-oss-120b","openai/gpt-oss-20b"];
